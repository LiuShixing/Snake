...
public:
	...
	void GameSoundReadWAVfile(char*,HMMIO&);  //将声音文件读入并将明细存在HMMIO结构中  0
	void GameSoundReadinbuffer(LPDIRECTSOUNDBUFFER&,char*);   //将声音文件读入次缓冲区中  0
	...
	LPDIRECTSOUNDBUFFER pyudimusic;   //攻击声音指针
